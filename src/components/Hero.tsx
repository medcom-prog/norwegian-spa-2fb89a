  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-ocean-900 via-ocean-900/75 to-ocean-900/30" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-5 md:px-8 pb-20 pt-32">
        ...
        <motion.h1
          {...fadeUp(0.1)}
          className="font-display text-display-xl text-white max-w-3xl mb-6 leading-[1.02]"
        >
          {site.hero.headline}
        </motion.h1>
        ...
        <motion.p
          {...fadeUp(0.2)}
          className="font-sans text-lg text-stone-300 max-w-xl mb-10 leading-relaxed"
        >
          {site.hero.subhead}
        </motion.p>
        ...
        >
          ...
          {site.hero.secondary_cta && (
            <a
              ...
              className="inline-flex items-center justify-center border border-white/25 hover:border-white/50 text-white font-sans font-medium text-base px-7 py-3.5 rounded-full transition-colors"
            >
      ...
      <motion.div
        ...
        className="relative z-10 border-t border-white/10 bg-ocean-900/80 backdrop-blur-sm"
      >
        <div className="container mx-auto px-5 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {stats.map((s) => (
              <div key={s.label} className="px-4 md:px-8 py-5">
                <p className="font-display text-xl md:text-2xl text-gold-400 leading-none mb-1">
                  {s.value}
                </p>
